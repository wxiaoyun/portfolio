...
\begin{multicols}{2}
    \begin{itemize}[label=\textbullet]
    \item {\textbf{Programming Languages:} Typescript, Rust, Go, Python, Java}
    \item {\textbf{Technologies:} Reactjs, Solidjs, PostgreSQL, Redis}
    \end{itemize}
\end{multicols}
