...
\makecvtitle
\vspace*{-16mm}
\begin{center}\textbf{Graduating in August 2026}\end{center}
\begin{center}
\begin{tabular}{ c c c }
...
\item Enhanced on-call efficiency for Wallet services by developing AI-driven analysers and auto-conclusion features in the Oncall Agent; utilised Golang, LLMs, and vector databases to rank relevant events, correlate error logs with code locations, and suggest root causes, significantly reducing engineers' on-call burden and improving overall development efficiency.
\end{itemize}}}
...
{\begin{itemize}[leftmargin=0.6cm, label={\textbullet}]
\item Reduced CI/CD pipeline and production deployment times by 33\% (from 15 to 10 minutes) by migrating the Money Platform from {\color{blue}\href{https://webpack.js.org/}{Webpack}} to {\color{blue}\href{https://rspack.dev/}{Rspack}}, doubling asset bundling speed. Drove cross-functional collaboration with Rspack, {\color{blue}\href{https://rsbuild.dev/}{Rsbuild}}, and TikTok LIVE Solutions teams.
...
{\begin{itemize}[leftmargin=0.6cm, label={\textbullet}]
\item Improved backend throughput by 5 times by migrating a Case Management System backend from Ruby on Rails to Golang. Notable features ported include RBAC, Auth, 2FA and Masquerading.
\end{itemize}}}
...
{\begin{itemize}[leftmargin=0.6cm, label={\textbullet}]
\item Engineered RustScript, a statically-typed language featuring a custom compiler and VM; implemented type-checking, concurrency primitives, and bytecode execution, achieving performance parity with similar interpreted languages.
\end{itemize}}}
...
\item Courses: CS2106 Operating Systems (A), CS3210 Parallel Computing (A), CS3211 Concurrent Programming (A), CS4212 Compiler Design (A-), CS5223 Distributed Systems
\end{itemize}}
...
\begin{multicols}{2}
    ...
    \item {\textbf{Databases:} SQL, Redis, Vector DBs}
    \item {\textbf{Tools/Frameworks:} React, SolidJS}
    \end{itemize}
\end{multicols}

% \textit{Letter of endorsement on the next page}
