...
{\begin{itemize}[leftmargin=0.6cm, label={\textbullet}]
\item Improved backend performance by 5 times by migrating a Case Management System backend from Ruby on Rails to Golang. Notable features ported include RBAC, Auth, 2FA and Masquerading.
\end{itemize}}}
